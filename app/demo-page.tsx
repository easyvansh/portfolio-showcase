...
export default function DemoPage(p:DemoProps){return <main className={`demo ${p.kind}`}>
  ...
  <section className="demo-cta" id="contact"><h2>{p.cta}</h2><a className="demo-btn" href="https://wa.me/?text=Hi%2C%20I%27d%20like%20to%20make%20an%20enquiry." target="_blank" rel="noreferrer">{p.ctaButton} ↗</a></section>
