...
export default function DemoPage(p:DemoProps){return <main className={`demo ${p.kind}`}>
  ...
  <section className="demo-cta" id="contact"><h2>{p.cta}</h2><a className="demo-btn" href="https://wa.me/17807081340" target="_blank" rel="noreferrer">{p.ctaButton} ↗</a></section>
